...
report_utils.compute_references(directories = ["QMENTA","USA","Germany","CEMCAT"])#,"USA7","Germany5","CEMCAT5","UK5"])

#Aggregation
report_utils.aggregate_tables(directories = ["QMENTA","USA","Germany","CEMCAT"])#,"USA7","Germany5","CEMCAT5","UK5"])
